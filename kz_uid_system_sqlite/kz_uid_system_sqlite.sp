...
void ShowWelcomePanel(int client) {
	...
	// 欢迎界面
	Panel sPanel = new Panel();
	sPanel.SetTitle("欢迎来到求生之路托儿所");
	
	sPanel.DrawText(" ");
	sPanel.DrawText("QQ群:725768476");
	sPanel.DrawText(" ");
	sPanel.DrawText("玩家指令:");
	sPanel.DrawText(" ");
	sPanel.DrawText("添加电脑:!addbot");
	sPanel.DrawText("加入游戏:!joingame");
	sPanel.DrawText("踢出电脑:!kickallbot");
	sPanel.DrawText("打开商店:!buy");
	sPanel.DrawText("自我了断:!zs");
	sPanel.DrawText("倒地自救:按住ctrl");
