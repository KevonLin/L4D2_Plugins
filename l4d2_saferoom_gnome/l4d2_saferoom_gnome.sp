...
Handle g_hCvarRemove = INVALID_HANDLE;
...
public Plugin myinfo = {
    name = "Saferoom Gnome",
    author = "devilesk, Lin",
    description = "Spawns a gnome in the saferoom",
    version = "1.3.1",
...
public void OnPluginStart() {
    ...
    g_hCvarRemove = CreateConVar("sm_saferoom_gnome_remove", "0", "Whether remove the gnome or not", 0, true, 0.0, true, 1.0);
