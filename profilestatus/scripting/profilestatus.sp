...
public void OnPluginStart() {
	...
	g_cvApiKey  			 = AutoExecConfig_CreateConVar("sm_profilestatus_apikey", "F073523F54BE0AACC334166FFB923E38", "Your Steam API key (https://steamcommunity.com/dev/apikey)", FCVAR_PROTECTED);
	...
	g_cvMinHours 			 = AutoExecConfig_CreateConVar("sm_profilestatus_hours_minhours", "400", "Minimum of hours requiered to enter the server.");
